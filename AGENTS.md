...
## PRE-WORK — RW-REPO-ROOT-REPACK-20260901

- Yêu cầu: khi phát hành lại ADAS `main`, nội dung package này phải nằm trực
  tiếp tại root repository để GitHub mở lên thấy ngay README, backend, frontend,
  scripts, models và media placeholders.
- Phạm vi: giữ nguyên E2E và landing page; chỉ thay đổi cấu trúc đóng gói trên
  remote, không thay model/runtime behavior và không force-push.
