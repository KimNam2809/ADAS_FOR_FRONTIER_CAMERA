"""RoadWatch Object V3 pilot on Kaggle GPU.

The pilot is deliberately isolated from the production model.  It validates
the remote training path, dataset materialization, checkpoint reload and ONNX
export before any full fine-tune or promotion is allowed.
"""
...
DATASET = TEMP / "roadwatch_object_v3_pilot_dataset"
TARGET = TEMP / "roadwatch_target_videos"
FRAMES = TEMP / "roadwatch_target_frames"
OUTPUT = WORK / "roadwatch_object_v3_pilot"
...
RUN_MODE = os.environ.get("ROADWATCH_RUN_MODE", "pilot_3_5_epoch")
